...
public class SweepAndPruneGame extends AbstractGame {
    ...
    private final int NUM_BALLS = 5; // 1000
    ...
    private final Rect arena = new Rect(0, 0, 100, 100); // 2000, 2000
    ...
    private void updateBallsPosition(float elapsedTime) {
        for (var b : balls) {
            // Update position
